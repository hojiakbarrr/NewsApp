...
class RobotFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.robot_fragment, container, false)

        recyclerview = v.findViewById(R.id.recRobot)
