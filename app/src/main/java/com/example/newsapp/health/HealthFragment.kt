package com.example.newsapp.health
...
class HealthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =  inflater.inflate(R.layout.health_fragment, container, false)

        recyclerview = v.findViewById(R.id.recHealth)

        recyclerview.layoutManager = GridLayoutManager(requireContext(),1)

        val ss =  Ssylka.allUsers

        val apiInterface = ApiInterface.create().getNewsCategory(ss,ApiInterface.HEALTH,100,ApiInterface.API_KEY)
